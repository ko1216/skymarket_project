# Generated by Django 3.2.6 on 2023-12-14 22:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='last_name',
            field=models.CharField(blank=True, max_length=35, null=True, verbose_name='Фамиля'),
        ),
        migrations.AddField(
            model_name='user',
            name='phone',
        ...
        migrations.AlterField(
            model_name='user',
            name='role',
            field=models.CharField(blank=True, choices=[('user', 'user'), ('admin', 'admin')], default='user', max_length=9, null=True, verbose_name='Роль'),
        ),
    ]
